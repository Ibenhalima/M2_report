...
% Pour l'architecture je ne sais pas si tu parles de notre infra ou celle de
% pipelines. Je te joins a ce mail mes schéma déguelasse ^^ 
% Faut mettre a jour la partie IT ++ mais les bases sont là 
...
% Perso dans le texte je ferai correspondre n
% J'introduirai la notion de pureté qq chose de très court 
% définirai la pureté dans la formule par un symbole
...
% J'ai lu la légende mais je pense que tu devrais mettre seuil t* optimal avec
% une couleur qui correspond au ----
% Beau formalisme ;) mais ne metterai tu pas au total le nombre d'échantillon 
% que tu récupères en applicant cette méthode ? 
