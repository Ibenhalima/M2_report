...
résultats ainsi produits \cite{duezVidjilWebPlatform2016}.

\vspace{1em}

La première composante, \textit{vidjil-algo} est un programme écrit en \texttt{C++}, dont la fonction est d'extraire 
les jonctions \gls{vdj} à partir des \textit{reads} (lectures) issues du séquençage à haut débit. Pour ce faire, l'algorithme 
...
minimiser les \textit{k-mers} communs aux deux segments. L'utilisation de \textit{k-mers} espacées permet d'améliorer la sensibilité 
