\begin{figure}[H]
    \centering
    \begin{tikzpicture}[node distance=0.3cm and 0cm, >=Stealth, thick, font=\small]
    ...
    \caption{Étapes successives de la recombinaison \gls{vdj} des loci des \glspl{ig}.
    ...
    en bas : schéma d'un fragment d'\gls{ig} complète.}
    \label{fig:vdj}
\end{figure}
