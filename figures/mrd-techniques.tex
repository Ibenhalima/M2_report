\begin{figure}[H]
    ...
    \node at (0,3) {\textbf{Maladie à expression clinique}};
    \node at (0,1) {\textbf{\gls{mrd}}};
    \node at (0,-1.7) {\textbf{\gls{mrd} non quantifiable}};
    ...
    \node[align=center] at (7.5,-2.7) {\gls{mrd} non détectable \\ avec les méthodes actuelles};
    \node[align=center] at (7.5,-3.7) {\textbf{Guérison}};
